...
public class DriverService {
    ...
    public ResponseEntity<?> setDriverAvailability(String email, boolean available) {
        ...
        User driver=userRepository.findByEmail(email).orElseThrow(()->new UsernameNotFoundException("User not found"));
        ...
        return ResponseEntity.status(HttpStatus.OK).body(Map.of("Message","Driver Availability Updated  to "+available));
    }
}
